...
function Yetkazib_b_tolov() {
    ...
    return(
        ...
        <div className="form_bottom">
            <div className="form">
            <Textarea name="izoh"  onChange={formik.handleChange} value={formik.values.izoh} title={"Izoh qoldirish"} placeholder={"O’z izohingizni qoldiring"}/>
            </div>
            <div>
...
export default Yetkazib_b_tolov